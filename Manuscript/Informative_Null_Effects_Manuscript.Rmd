...
It is important to note, that the confidence intervals here are only used to conduct the two one-sided tests (TOST).
The interpretation of confidence intervals in a frequentist estimation frameworks has been critically discussed e.g. by @Morey2016.
...
Thus, it is up to the researcher to decide whether they want to make a dichotomous decision about a single parameter value or rather make a probability statement (cf. Discussion section on inferential frameworks).
