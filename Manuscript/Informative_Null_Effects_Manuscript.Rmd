...
Thus, although the data support the null model over the alternative model specified by the prior, there is no good reason to conclude in favor of either model. 
...
The Bayes factor contains the neccessary information to make an inference, but is not by itself sufficint to reach a conclusion.
