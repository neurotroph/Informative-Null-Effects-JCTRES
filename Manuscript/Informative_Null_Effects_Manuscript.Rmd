...
This does not rule out the possibility that the true effect size in the population differs from zero.^[In fact, one can argue that it is most likely that the true effect size is unequal to zero.
